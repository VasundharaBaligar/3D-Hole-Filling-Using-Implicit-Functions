...
file_path = "D:\occupancy_networks\PLY\irplane_1.ply"
...
for i in range(num_holes):
    ...
    hole_radius = 0.0285 # Adjust this value as needed
...
print(pc.shape)
status = savePC(pc, desti, "output_pointcloud_with_holes")
print("{}/{}".format(desti, "output_pointcloud_with_holes"))
